 ...
 */
final class Version20210108133241 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE User (id INT AUTO_INCREMENT NOT NULL, adr_id_user INT DEFAULT NULL, company_delivery_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles TEXT NOT NULL COMMENT \'(DC2Type:json_array)\', password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, created_at_user DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, valid_user TINYINT(1) DEFAULT \'0\' NOT NULL, deleted_user TINYINT(1) DEFAULT \'0\' NOT NULL, admin_user TINYINT(1) DEFAULT \'0\' NOT NULL, super_admin TINYINT(1) DEFAULT \'0\' NOT NULL, img VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_2DA17977F85E0677 (username), UNIQUE INDEX UNIQ_2DA17977BBC2C8AC (img), INDEX IDX_2DA17977EB5D4312 (adr_id_user), UNIQUE INDEX UNIQ_2DA17977BC2D1B9 (company_delivery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Access (id INT AUTO_INCREMENT NOT NULL, id_user_acc INT NOT NULL, code_acc VARCHAR(255) NOT NULL, created_at_acc DATETIME NOT NULL, used_acc TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1C52E62C41F4729 (code_acc), INDEX IDX_1C52E6297F2FD9D (id_user_acc), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE TypeDeliverySelected (id INT AUTO_INCREMENT NOT NULL, type_delivery_id INT NOT NULL, command_id INT NOT NULL, mem_price_del INT NOT NULL, INDEX IDX_98A5DB9D590ABEB0 (type_delivery_id), UNIQUE INDEX UNIQ_98A5DB9D33E1689A (command_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Command (id INT AUTO_INCREMENT NOT NULL, adr_id_com INT DEFAULT NULL, del_id_com INT DEFAULT NULL, user_id_com INT DEFAULT NULL, create_at_com DATETIME NOT NULL, completed TINYINT(1) NOT NULL, date_receive DATETIME DEFAULT NULL, is_basket TINYINT(1) NOT NULL, price_total INT DEFAULT NULL, num_com VARCHAR(255) NOT NULL, deleted_com TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_4177D3487431C748 (num_com), INDEX IDX_4177D348AC18573C (adr_id_com), INDEX IDX_4177D348347BAB22 (del_id_com), INDEX IDX_4177D3489F403581 (user_id_com), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Delivery (id INT AUTO_INCREMENT NOT NULL, comp_del_id_del INT NOT NULL, num_del VARCHAR(255) NOT NULL, date_del DATE DEFAULT NULL, departments JSON DEFAULT NULL, deleted_del TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_CEF78E46FC9609D1 (num_del), INDEX IDX_CEF78E46875C0859 (comp_del_id_del), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE User ADD CONSTRAINT FK_2DA17977EB5D4312 FOREIGN KEY (adr_id_user) REFERENCES Address (id)');
        $this->addSql('ALTER TABLE User ADD CONSTRAINT FK_2DA17977BC2D1B9 FOREIGN KEY (company_delivery_id) REFERENCES CompanyDelivery (id)');
        ...
        $this->addSql('ALTER TABLE TypeDeliverySelected ADD CONSTRAINT FK_98A5DB9D590ABEB0 FOREIGN KEY (type_delivery_id) REFERENCES TypeDelivery (id)');
        $this->addSql('ALTER TABLE TypeDeliverySelected ADD CONSTRAINT FK_98A5DB9D33E1689A FOREIGN KEY (command_id) REFERENCES Command (id)');
        $this->addSql('ALTER TABLE Command ADD CONSTRAINT FK_4177D348AC18573C FOREIGN KEY (adr_id_com) REFERENCES Address (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE TypeDeliverySelected');
