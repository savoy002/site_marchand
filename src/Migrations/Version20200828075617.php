 ...
 */
final class Version20200828075617 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Comment (id INT AUTO_INCREMENT NOT NULL, user_id_comment INT DEFAULT NULL, prod_id_comment INT DEFAULT NULL, mark_comment INT NOT NULL, text_comment LONGTEXT NOT NULL, created_at_user DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, deleted_comment TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_5BC96BF0ED8E3DF0 (user_id_comment), INDEX IDX_5BC96BF09A7C4C37 (prod_id_comment), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VariantProduct (id INT AUTO_INCREMENT NOT NULL, prod_id_var_prod INT DEFAULT NULL, name_var_prod VARCHAR(255) NOT NULL, img_var_prod VARCHAR(255) DEFAULT NULL, desc_var_prod LONGTEXT DEFAULT NULL, stock_var_prod INT NOT NULL, code_var_prod VARCHAR(255) NOT NULL, price INT NOT NULL, activate_var_prod TINYINT(1) DEFAULT \'0\' NOT NULL, deleted_var_prod TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_3DFA05BCB304425F (code_var_prod), INDEX IDX_3DFA05BCB632BA16 (prod_id_var_prod), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
