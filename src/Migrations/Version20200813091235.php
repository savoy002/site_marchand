 ...
 */
final class Version20200813091235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Comment (id INT AUTO_INCREMENT NOT NULL, user_id_comment INT DEFAULT NULL, prod_id_comment INT DEFAULT NULL, mark_comment INT NOT NULL, text_comment LONGTEXT NOT NULL, deleted_comment TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_5BC96BF0ED8E3DF0 (user_id_comment), INDEX IDX_5BC96BF09A7C4C37 (prod_id_comment), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Command (id INT AUTO_INCREMENT NOT NULL, adr_id_com INT DEFAULT NULL, del_id_com INT DEFAULT NULL, user_id_com INT DEFAULT NULL, create_at_com DATETIME NOT NULL, completed TINYINT(1) NOT NULL, date_receive DATETIME DEFAULT NULL, price_total INT DEFAULT NULL, deleted_com TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_4177D348AC18573C (adr_id_com), INDEX IDX_4177D348347BAB22 (del_id_com), INDEX IDX_4177D3489F403581 (user_id_com), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Adress (id INT AUTO_INCREMENT NOT NULL, street VARCHAR(255) NOT NULL, zip_code INT NOT NULL, city VARCHAR(255) NOT NULL, deleted_adr TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VariantProduct (id INT AUTO_INCREMENT NOT NULL, prod_id_prod_var INT DEFAULT NULL, name_var_prod VARCHAR(255) NOT NULL, img_var_prod VARCHAR(255) DEFAULT NULL, desc_var_prod LONGTEXT DEFAULT NULL, stock_var_prod INT NOT NULL, code_var_prod VARCHAR(255) NOT NULL, price INT NOT NULL, activate_var_prod TINYINT(1) DEFAULT \'0\' NOT NULL, deleted_var_prod TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_3DFA05BCB304425F (code_var_prod), INDEX IDX_3DFA05BCDADD227B (prod_id_prod_var), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
