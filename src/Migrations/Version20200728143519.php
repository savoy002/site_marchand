 ...
 */
final class Version20200728143519 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Delivery (id INT AUTO_INCREMENT NOT NULL, comp_del_id_del INT NOT NULL, date_del DATE DEFAULT NULL, INDEX IDX_CEF78E46875C0859 (comp_del_id_del), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE TypeDelivery (id INT AUTO_INCREMENT NOT NULL, comp_del_id_del INT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, time_min INT NOT NULL, time_max INT NOT NULL, INDEX IDX_8AAFDB36875C0859 (comp_del_id_del), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Delivery ADD CONSTRAINT FK_CEF78E46875C0859 FOREIGN KEY (comp_del_id_del) REFERENCES TypeDelivery (id)');
